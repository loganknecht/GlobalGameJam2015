...
namespace FullInspector.Internal {
    ...
    public static class fiDefaultSerializerRewriter {
        private static string OutputFilePath = fiUtility.CombinePaths(fiSettings.RootDirectory, "Serializers/Generated/" + fiSerializerProxy.GeneratedTypeName + ".cs");
        private static string OutputBehaviorPath = fiUtility.CombinePaths(fiSettings.RootDirectory, "Serializers/Generated/BaseBehavior.cs");
        private static string OutputScriptableObjectPath = fiUtility.CombinePaths(fiSettings.RootDirectory, "Serializers/Generated/BaseScriptableObject.cs");
        private static string OutputDirectory = fiUtility.CombinePaths(fiSettings.RootDirectory, "Serializers/Generated/");
        ...
        public static void Generate() {
            ...
            if (fiSerializerProxy.HasDefault) {
                defaultProvider = GetTypeName(fiSerializerProxy.DefaultMetadata.GetType());
                defaultSerializer = GetTypeName(fiSerializerProxy.DefaultMetadata.SerializerType);
            }
            else {
                defaultProvider = null;
                defaultSerializer = null;

                foreach (var metadata in fiSerializerProxy.LoadedMetadata) {
        ...
        private static void GenerateFileInternal(string defaultProvider, List<string> allProviders) {
            ...
            Append(builder, "    public class " + fiSerializerProxy.GeneratedTypeName + " : fiILoadedSerializers {");
