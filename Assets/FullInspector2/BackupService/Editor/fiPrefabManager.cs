...
namespace FullInspector.BackupService {
    ...
    public static class fiPrefabManager {
        private static string PrefabPath = fiUtility.CombinePaths(fiSettings.RootDirectory, "fiBackupStorage.prefab");
            ...
            get {
                if (_storage == null) {
                    ...
                    if (prefabGameObject == null) {
                        ...
                        prefabGameObject = (GameObject)PrefabUtility.CreatePrefab(PrefabPath, cloned);
                        fiEditorUtility.DestroyObject(cloned);
